  ...
  const addAdmin = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        window.location.href = "/admin/Administrateurs";
      }
    } catch (error) {
            ...
            <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto">
              ...
              <form onSubmit={addAdmin}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <label className="text-gray-700 font-semibold">Prenom</label>
                    <Input
                      type="text"
                      name="Prenom"
                ...
                <div className="mb-4">
                  <label className="text-gray-700 font-semibold">Mot de passe (Min 8 charactéres)</label>
                  <Input
                    type="password"
                    name="Password"
