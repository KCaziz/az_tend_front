      ...
      <div className="flex">
        ...
        <div className="w-3/4 p-8">
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Ajouter un Tender</h2>
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-4">
              ...
              {/* Image */}
              <div>
                <label className="block text-gray-600 dark:text-gray-300 mb-2">Image (optionnel)</label>
                <input
                  type="file"
                  name="image"
                  accept="image/*"
